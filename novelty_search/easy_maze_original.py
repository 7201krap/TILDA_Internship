...
if __name__ == '__main__':
    ...
    if file_saved:
        accumulated_coordinates = np.load('easy_coordinates_accumulator_original.npy')
        accumulated_best_path = np.load('easy_best_path_original.npy')
        ...
        np.save('easy_coordinates_accumulator_original.npy', coordinates_accumulator)
        np.save('easy_best_path_original.npy', best_path_accumulator)
