...
if __name__ == '__main__':
    ...
    if file_saved:
        accumulated_coordinates = np.load('easy_coordinates_accumulator_novelty.npy')
        accumulated_best_path = np.load('easy_best_path_novelty.npy')
        ...
        np.save('easy_coordinates_accumulator_novelty.npy', coordinates_accumulator)
        np.save('easy_best_path_novelty.npy', best_path_accumulator)
